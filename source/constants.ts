...
export const TIMEOUT_FETCH_LOCAL_MODELS_MS = 2000;
export const TIMEOUT_FETCH_CLOUD_MODELS_MS = 10_000;
...
export const CACHE_MODEL_DATA_TTL_MS = 60 * 60 * 1000; // 1 hour
export const MAX_CACHE_FILE_SIZE = 50;
...
export const TRUNCATION_CONTEXT_LIMIT = 4000;
