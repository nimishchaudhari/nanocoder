...
- [VS Code Extension](#vs-code-extension)
  - [Installation](#vs-code-installation)
  - [Usage](#vs-code-usage)
...
![VS Code Diff Preview](./.github/assets/vscode-diff-preview.png)
...
If the extension isn't installed, you'll see a prompt asking if you'd like to install it. Press `y` to install automatically.
